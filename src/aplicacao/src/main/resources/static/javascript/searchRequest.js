document.addEventListener('DOMContentLoaded', function () {
    ...
    function setActiveTab(formElement, hostType) {
        ...
        tabPanes.forEach(pane => {
            const paneType = pane.id.split('-').pop();
    ...
    // ===================================================================
    //  FUNÇÕES DINÂMICAS PARA ABRIR E PREENCHER CADA MODAL
    // ===================================================================
    ...
    // ===================================================================
    //  LISTENERS DE EVENTOS (ACESSO API RESTFUL)
    // ===================================================================
